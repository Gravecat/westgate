...
public:
    ...
    static void         process_conditional_tags(std::string& str, const std::string_view tag, bool active);
    static std::string  str_tolower(const std::string_view str);    // Converts a string to lower-case.
    static std::string  str_toupper(const std::string_view str);    // Converts a string to upper-case.
    static std::vector<std::string> string_explode(const std::string_view str, const std::string_view separator = " "); // String split/explode function.
