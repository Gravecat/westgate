...
int32_t     parse_number(std::string_view num); // Attempts to parse a string into a number; invalid results are set to INT_MIN.
void        process_input(std::string_view input);  // Processes input from the player.
