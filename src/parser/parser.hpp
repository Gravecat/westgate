...
Direction   parse_direction(hash_wg hash);  // Parses a hashed string into a Direction enum.
int         parse_number(const std::string_view num);   // Attempts to parse a string into a number; invalid results are set to INT_MIN.
